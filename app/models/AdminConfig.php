...
class AdminConfig extends Eloquent
{
    ...
    protected $fillable = [
        ...
        'text_order_notify','text_footer_order','like_link','share_link','message_to', 'text_config_title', 'google_code', 'link_video', 'text2', 'text3', 'fb_analytic', 'discount_default', 'expire_date', 'text_next_step', 'fb_image'
    ];
