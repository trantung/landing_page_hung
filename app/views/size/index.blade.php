...
@section('content')
    <div class="row margin-bottom">
        <div class="col-xs-12">
                {{ renderUrl('SizeController@create', '<i class="glyphicon glyphicon-plus-sign"></i> Thêm size', [], ['class' => 'btn btn-primary']) }}
        </div>
    </div>
    <table class ="table table-bordered table-striped table-hover">
        ...
        <tr>
            ...
            <td>
                {{ renderUrl('SizeController@edit', 'Sửa', [$size->id], ['class' => 'btn btn-warning']) }}
