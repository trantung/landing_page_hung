    ...
    <div class="content-product" >
       ...
       {{ Form::open(array('action' => array('OrderController@store'), 'method' => "POST", 'class' => 'layui-form')) }}
        ...
        <div class="form-group-p">
           ...
           {{ Form::select('kind_id', AdminKind::lists('name', 'id'), array('id' => 'kindChange', 'class' => 'form-control') }}
        </div>  

        <div class="form-group-p">
            <label>Kích thước</label>
            {{ Form::select('size_id', Size::lists('name', 'id'), array('id' => 'sizeChange', 'class' => 'form-control') }}
        </div>
