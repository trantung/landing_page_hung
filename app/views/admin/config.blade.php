                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div>
                                <label>Ảnh Facebook</label>
                                <input type="file" name="fb_image" class="form-control"><br>
                                <img src="{{ !empty($config->fb_image) ? url($config->fb_image) : NO_IMG }}"width="150px" height="auto"  />
                            </div>
