    ...
    <div class="layui-main">
            ...
            <div class="swiper-wrapper"> 
                <div class="item">
                    <a class="swiper-slide" href="#">
                        <img src="images/header-1.jpg" width="100%" height=""/>
                    </a>
                </div>
                <div class="item">
                    <a class="swiper-slide" href="#">
                        <img src="images/header-2.jpg" width="100%" height=""/>
                    </a>
                </div> 
            </div>
        </div>
        ...
        <div class="layui-product-info">
            ...
            <div class="layui-product-size">
                ...
                <div class="layui-product-images"> <img src="images/content.jpg" alt="" /> </div>
                <div class="layui-row">
                            ...
                            <div class="layui-comment">
                                ...
                                <div class="layui-commet-info">
                                    ...
                                    <div class="comment_picture">
                                        <a href="javascript:;"><img class="cpic" src="images/anh-cm-3.jpg"></a>
                                        <a href="javascript:;"><img class="cpic" src="images/anh-cm-4.jpg"></a>                 
                                    </div>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="layui-comment">
                                ...
                                <div class="layui-commet-info">
                                    ...
                                    <div class="comment_picture">
                                        <a href="javascript:;"><img class="cpic" src="images/anh-cm-1.jpg"></a>                  
                                    </div>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="layui-comment">
                                ...
                                <div class="layui-commet-info">
                                    <p>Đập trai ^^</p>
                                    <div class="comment_picture">
                                        <a href="javascript:;"><img class="cpic" src="images/anh-cm-2.jpg"></a>                  
                                    </div>
                                </div>
                            </div>
                        </li>            
            ...
            <form class="layui-form" action="http://localhost/ionlinei.com/dat-hang.php" method="post">
                <div class="layui-product-title layui-row">
                    <div class="layui-col-xs3 layui-image"> 
                        <img src=" images/sp-do.jpg" id="sizeimg"/> 
                    </div>
                    ...
                    <div class="layui-product-info" style="border-bottom:1px solid #dcdcdc;">
                        <div class="layui-product-size">
                            ...
                            <div class="layui-product-size-list layui-row layui-col-space5" id="sizeselect">
                                <div class="layui-size layui-col-xs3 active" data-field="Đỏ" data-price="250000" data-img="images/sp-do.jpg">
                                    <div class="layui-elip"><img src="images/sp-do.jpg" width="100%"> 
                                    </div>
                                </div>
                                <div class="layui-size layui-col-xs3 " data-field="Tím" data-price="250000" data-img="images/sp-tim.jpg">
                                    <div class="layui-elip">
                                        <img src="images/sp-tim.jpg" width="100%"> 
                                    </div>
                                </div><div class="layui-size layui-col-xs3 " data-field="Khói" data-price="250000" data-img="images/sp-khoi.jpg">
                                    <div class="layui-elip">
                                        <img src="images/sp-khoi.jpg" width="100%"> 
                                    </div>
                                </div>
                                <div class="layui-size layui-col-xs3 " data-field="Vàng" data-price="250000" data-img="images/sp-vang.jpg">
                                    <div class="layui-elip">
                                        <img src="images/sp-vang.jpg" width="100%"> 
                                    </div>
                                </div>
                                <div class="layui-size layui-col-xs3 " data-field="Bạc" data-price="250000" data-img="images/sp-bac.jpg">
                                    <div class="layui-elip">
                                        <img src="images/sp-bac.jpg" width="100%">
                                    </div>
                                </div>           
                            </div>
                        </div>                             
